...
filtered_gauss = cv2.GaussianBlur(noisy_gauss, (5, 5), 1.0)
...
plt.subplot(133); plt.imshow(filtered_gauss, cmap='gray'); plt.title('После гауссовского фильтра'); plt.axis('off')
plt.suptitle('Гауссовский шум → Гауссовский фильтр')
plt.show()
...
# Применяем гауссовский фильтр
filtered_sp = cv2.GaussianBlur(noisy_sp, (5, 5), 1.0)

# Показываем результат
plt.figure(figsize=(15, 5))
plt.subplot(131); plt.imshow(image, cmap='gray'); plt.title('Оригинал'); plt.axis('off')
plt.subplot(132); plt.imshow(noisy_sp, cmap='gray'); plt.title('Соль-перец'); plt.axis('off')
plt.subplot(133); plt.imshow(filtered_sp, cmap='gray'); plt.title('После гауссовского фильтра'); plt.axis('off')
plt.suptitle('Импульсный шум (соль-перец) → Гауссовский фильтр')
plt.show()
...
# Применяем гауссовский фильтр
filtered_speckle = cv2.GaussianBlur(noisy_speckle, (5, 5), 1.0)

# Показываем результат
plt.figure(figsize=(15, 5))
plt.subplot(131); plt.imshow(image, cmap='gray'); plt.title('Оригинал'); plt.axis('off')
plt.subplot(132); plt.imshow(noisy_speckle, cmap='gray'); plt.title('Спекл-шум'); plt.axis('off')
plt.subplot(133); plt.imshow(filtered_speckle, cmap='gray'); plt.title('После гауссовского фильтра'); plt.axis('off')
plt.suptitle('Спекл-шум → Гауссовский фильтр')
plt.show()
...
# Применяем гауссовский фильтр
filtered_poisson = cv2.GaussianBlur(noisy_poisson, (5, 5), 1.0)

# Показываем результат
plt.figure(figsize=(15, 5))
plt.subplot(131); plt.imshow(image, cmap='gray'); plt.title('Оригинал'); plt.axis('off')
plt.subplot(132); plt.imshow(noisy_poisson, cmap='gray'); plt.title('Пуассоновский шум'); plt.axis('off')
plt.subplot(133); plt.imshow(filtered_poisson, cmap='gray'); plt.title('После гауссовского фильтра'); plt.axis('off')
plt.suptitle('Пуассоновский шум → Гауссовский фильтр')
plt.show()
